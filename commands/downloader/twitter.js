module.exports = [{
  ...
  code: async(zxn, m, { global, remote, zn, text, alert, sendError, isUrl, formatSize, fs }, { twdl, readmore }) => {
    try {
      if(!text) return zxn.reply(remote, `${zn.emoji("failed")}︱Mana url video twitter nya?\n*Contoh:* .twitter https://twitter.com/tiebanonini/status/1706146039957459057`);
      if(!isUrl(text)) return zxn.reply(remote, `${zn.emoji("alert")}︱Link video twitter tidak valid!`);
